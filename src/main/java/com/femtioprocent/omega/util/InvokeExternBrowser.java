 ...
 */
public class InvokeExternBrowser {
        ...
        switch (jvm) {
            ...
            case MRJ_3_0:
                try {
                    ...
                    linkage = constructor.newInstance(new Object[]{InvokeExternBrowser.class});
                } catch (ClassNotFoundException cnfe) {
                    errorMessage = cnfe.getMessage();
                    return false;
                } catch (NoSuchMethodException nsme) {
    ...
    public static boolean show_if(String url_s) {
        if (OmegaContext.extern_help_browser) {
            try {
                InvokeExternBrowser.openURL(url_s);
