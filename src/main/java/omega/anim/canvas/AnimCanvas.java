...
public class AnimCanvas extends omega.graphic.render.Canvas {
...
//	omega.OmegaContext.sout_log.getLogger().info("ERR: " + "m d " + e.getX() + ',' + e.getY());
    ...
    void popup_maction(MouseEvent e, final Path pa) {
        ...
        omega.swing.Popup pop = new omega.swing.Popup(this);
