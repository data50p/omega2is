...
//log		omega.Context.sout_log.getLogger().info("ERR: " + "read lessond " + ch);
                if (ch == -1)
                    break;
    ...
    public void run() {
        ...
        if (omega.Config.T) omega.Context.sout_log.getLogger().info("ERR: " + "lessond Connection established");
        try {
